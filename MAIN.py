...
def telemetry(sid, data):
    if data:
        ...
        '''
        pts = np.float32([[120,100], [190,100], [0,174],[300,174]])
        for x in range(0,4):
            cv2.circle(image,(pts[x][0], pts[x][1]),5, (0,0,255),-1)
        cv2.imshow("image_input", image)
        
        t = np.copy(lane_image)
        cv2.circle(t, (0,100),5,(0,0,255),-1)
        cv2.circle(t, (300, 100), 5, (0, 0, 255), -1)
        cv2.circle(t, (0, 200), 5, (0, 0, 255), -1)
        cv2.circle(t, (300, 200), 5, (0, 0, 255), -1)
        cv2.imshow('t',t)
        '''
...
def ROI(image):
    ...
    shape = np.array([[10, height], [320, height], [300, 130], [50,130]])
...
def display_lines(image,lines):
    ...
    for line in lines:
        ...
        xa = int((x1+x2)/2-90)# red 100
        ya = int((y1+y2)/2)
        cv2.circle(line_image,(xa-20,ya),5,(0,255,0),-1)
        x_d = xa - 160 # green 150
